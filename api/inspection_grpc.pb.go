...
type InspectServiceClient interface {
	...
	PrintString(ctx context.Context, in *PrintStringRequest, opts ...grpc.CallOption) (*PrintStringResponse, error)
}
...
func (c *inspectServiceClient) PrintString(ctx context.Context, in *PrintStringRequest, opts ...grpc.CallOption) (*PrintStringResponse, error) {
	out := new(PrintStringResponse)
	err := c.cc.Invoke(ctx, "/api.InspectService/PrintString", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InspectServiceServer interface {
	...
	PrintString(context.Context, *PrintStringRequest) (*PrintStringResponse, error)
...
func (UnimplementedInspectServiceServer) PrintString(context.Context, *PrintStringRequest) (*PrintStringResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrintString not implemented")
}
...
func _InspectService_PrintString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PrintStringRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InspectServiceServer).PrintString(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.InspectService/PrintString",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InspectServiceServer).PrintString(ctx, req.(*PrintStringRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InspectService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InspectService_PrintString_Handler,
		},
	},
